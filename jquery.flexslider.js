...
(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      init: function() {
        ...
        if (slider.vars.controlsNavContainer !== "") slider.controlsNavContainer = $(slider.vars.controlsNavContainer).length > 0 && $(slider.vars.controlsNavContainer);
        // MANUAL:
      ...
      asNav: {
        setup: function() {
          ...
          if(!msGesture){
              slider.slides.on(eventType.split(' ').join(slider.vars.eventNamespace + ' '), function(e){
                e.preventDefault();
                var $slide = $(this),
                    target = $slide.index();
      ...
      controlNav: {
        ...
        setupPaging: function() {
          ...
          // CONTROLSCONTAINER:
          (slider.controlsNavContainer) ? $(slider.controlsNavContainer).append(slider.controlNavScaffold) : slider.append(slider.controlNavScaffold);
        ...
        set: function() {
          ...
          slider.controlNav = $('.' + namespace + 'control-nav li ' + selector, (slider.controlsNavContainer) ? slider.controlsNavContainer : slider);
        },
        active: function() {
    ...
    slider.destroy = function() {
      ...
      $(document).unbind(slider.vars.eventNamespace + "-" + slider.id); // Remove events
      $(window).unbind(slider.vars.eventNamespace + "-" + slider.id); // Remove events
      ...
      clearTimeout(destroy_delay);

      destroy_delay = setTimeout(function(){
  ...
  $.flexslider.defaults = {
    ...
    controlsNavContainer: "",       //{NEW} Separate container for navigation
